...
import net.sarangnamu.util.drag.DragScroller;
import net.sarangnamu.util.drag.DragSource;
import net.sarangnamu.util.drag.DragView;
import net.sarangnamu.util.drag.DropTarget;
...
public class Workspace extends ViewGroup implements DropTarget, DragSource, DragScroller {
    ...
    public void computeScroll() {
        if (mScroller.computeScrollOffset()) {
            ...
            if (dx > 1.f || dx < -1.f) {
                //                updateWallpaperOffset();
                postInvalidate();
                Log.d(TAG, "computeScroll postInvalidate");
            }
        }
    }
    ...
    private IWorkspaceParent parent = null;
    public static ArrayList<String> urls = new ArrayList<String>();

    public interface IWorkspaceParent {
        public boolean isWorkspaceLocked();
    }

    public void setListener(IWorkspaceParent l) {
        parent = l;
    }

    public void adddUrl(final String url) {
        urls.add(url);
    }

    public void load() {
        for (String url : urls) {
            CellLayout v = new CellLayout(mContext);
            addView(v);
            v.loadUrl(url);
        }
    }
