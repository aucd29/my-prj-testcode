...
public class TabbedHorizontalPagerDemo extends Activity {
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        findViewById(R.id.simple_demo_btn2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                Intent intent = new Intent(TabbedHorizontalPagerDemo.this,
                        HorizontalPagerDemo.class);
                intent.putExtra("cell", 3);
                startActivity(intent);
            }
        });

        findViewById(R.id.simple_demo_btn3).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(final View v) {
                Intent intent = new Intent(TabbedHorizontalPagerDemo.this,
                        HorizontalPagerDemo.class);
                intent.putExtra("cell", 5);
                startActivity(intent);
            }
        });
    }
