...
import net.sarangnamu.common.ui.bitmap.Capture;
...
public class BlurView extends LinearLayout implements View.OnClickListener {
...
//        });
    ...
    public void loadParentView() {
        Log.d(TAG, "loadParentView");
//        setAlpha(0);
...
//        }
    ...
    public void capture() {
        ...
        if (view != null) {
            DLog.e(TAG, "capture ok");
            bmp = fastblur(Capture.get(view), 13);
            invalidate();
        } else {
            Log.e(TAG, "loadParentView");
        }
    }
