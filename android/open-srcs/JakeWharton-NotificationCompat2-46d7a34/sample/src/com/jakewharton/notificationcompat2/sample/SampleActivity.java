...
public class SampleActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.high_priority).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        findViewById(R.id.low_priority).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        findViewById(R.id.max_priority).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        findViewById(R.id.min_priority).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        findViewById(R.id.big_picture).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        ...
                        .setSummaryText("http://curious-creature.org").build());
                    }
                });
        findViewById(R.id.big_picture_api).setOnClickListener(
                new OnClickListener() {
                    @Override
                    public void onClick(View view) {
        ...
        findViewById(R.id.big_text).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mgr.notify(R.id.big_text, new NotificationCompat2.BigTextStyle(
                        getSimple("Big Text")).bigText(
        ...
        findViewById(R.id.inbox).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mgr.notify(R.id.inbox,
                        new NotificationCompat2.InboxStyle(getSimple("Inbox"))
                .addLine("Line One").addLine("Line Two")
                .addLine("Line Three").addLine("Line Four")
                .addLine("Line Five").build());
            }
        });
        findViewById(R.id.actions).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                mgr.notify(R.id.actions,getSimple("Actions").
                        ...
                        .addAction(android.R.drawable.sym_def_app_icon, "Two", getPendingIntent()).build());
            }
        });
        findViewById(R.id.progress).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mgr.notify(R.id.progress,
                        getSimple("Progress").setProgress(0, 0, true).build());
            }
        });
    }
