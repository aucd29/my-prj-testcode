 ...
 * @since 4.0
 *
 * @deprecated (4.2) use {@link org.apache.http2.nio.reactor.ssl.SSLIOSession}
 */
@Deprecated
public class SSLIOSession extends org.apache.http2.nio.reactor.ssl.SSLIOSession {
    ...
    public SSLIOSession(
        ...
        super(session, org.apache.http2.nio.reactor.ssl.SSLMode.CLIENT,
    ...
    public synchronized void bind(
        ...
        org.apache.http2.nio.reactor.ssl.SSLSetupHandler handler = getSSLSetupHandler();
    ...
    private org.apache.http2.nio.reactor.ssl.SSLMode convert(final SSLMode mode) {
        switch(mode) {
        case CLIENT:
            return org.apache.http2.nio.reactor.ssl.SSLMode.CLIENT;
        case SERVER:
            return org.apache.http2.nio.reactor.ssl.SSLMode.SERVER;
        }
        return null;
    }
