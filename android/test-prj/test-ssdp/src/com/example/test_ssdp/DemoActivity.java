...
import com.example.test_ssdp_device.R;
        ...
        public void onServiceConnected(ComponentName className, IBinder service) {
            ...
            if (switchPowerService == null) {
                try {
                    ...
                    Toast.makeText(DemoActivity.this, "registering_demo_device", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(DemoActivity.this, "create_demo_failed", Toast.LENGTH_SHORT).show();
                    return;
                }
            }
    ...
    protected LocalDevice createDevice()
        ...
        DeviceDetails details =
                new DeviceDetails(
                        ...
                        new ModelDetails("AndroidLight2", "A demo light with on/off switch.", "v2")
                        );
