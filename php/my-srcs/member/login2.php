...
<form name='loginform' method=POST action='/member/member_process.php?psMode=LOGIN' onsubmit='return SoftCheck(this);' style='margin:0;border:0'>
	...
	<tr>
		<td><img src='/member/img/loginformttl.gif'></td>
	</tr>
	<tr><td height='60'><li>아이디와 패스워드를 입력하신후 로그인 해주십시요.</li></td></tr>
	<tr>
		<td background='/member/img/loginformback.gif' align='center'>

			<table border='0' cellpadding='2' cellspacing='0' align=center width=260>
			<tr><td colspan=3 height=25></td></tr>
			<tr>
				<td width='50'></td>
				<td align='center'><input tabindex='1' type='text' name='sID' hame='아이디' required='required' size=15 maxlength=15 class='box'></td>
			...
			<tr>
				<td colspan='3' align=center><font size='1' color='#FF9900'>▶ </font><a href='/member/member_write.php'>회원가입</a>
